...
export default function WrittenByRiversPage() {
  return (
    <article className={`bg-white text-black min-h-screen selection:bg-[#1A3A2A] selection:text-white ${lora.className}`}>
      
      {/* SECTION 1 — HERO BLOCK */}
      <section className="relative w-full h-[85vh] min-h-[600px] flex items-end overflow-hidden pt-[64px]"> {/* pt-[64px] offsets the nav if needed */}
        <div className="absolute inset-0 z-0">
          <Image 
            ...
            priority
          />
          {/* Subtle overlay to ensure text legibility while maintaining the visual */}
          <div className="absolute inset-0 bg-black/30" />
        </div>
        
        <div className="relative z-10 w-full p-8 md:p-16 lg:p-24 pb-8 md:pb-16 flex flex-col gap-4 text-white">
          <span className="font-mono text-xs tracking-[0.2em] uppercase font-light">
            BRANDING · APRIL 2026
          </span>
          <h1 className="font-bebas text-6xl md:text-[80px] lg:text-[100px] leading-[0.9] tracking-wide m-0">
            Written by Rivers
          </h1>
          <p className="font-sans text-xl md:text-[22px] max-w-[800px] font-light leading-relaxed mt-2 opacity-90">
      ...
      <div className="max-w-[1400px] mx-auto w-full">
        ...
        <section className="py-24 md:py-32 px-6 md:px-12 lg:px-24 flex flex-col md:flex-row gap-16 md:gap-24 justify-between">
          <div className="w-full md:w-[65%] text-[17px] md:text-[19px] leading-[1.8] text-[#111]">
            <p>
          ...
          <div className="w-full md:w-[35%] font-mono text-[13px] uppercase tracking-tight text-[#333]">
        ...
        <section className="w-full px-6 md:px-12 lg:px-24 pb-24 md:pb-32">
          <div className="w-full relative aspect-[21/9] bg-gray-50 overflow-hidden group">
            <Image 
        ...
        <section className="w-full bg-white py-16 md:py-24 my-8 md:my-16 border-y-2 border-[#1A3A2A]">
          <div className="max-w-[1000px] mx-auto px-6 text-center">
            <h2 className="text-3xl md:text-[40px] font-light italic text-[#111] leading-tight mb-8">
        ...
        <section className="px-6 md:px-12 lg:px-24 py-20 md:py-24 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          <div>
            <div className="relative aspect-[4/5] bg-gray-50 overflow-hidden mb-4 group">
              <Image 
          ...
          <div>
            <div className="relative aspect-[4/5] bg-[#1A3A2A]/5 overflow-hidden mb-4 group">
              <Image 
        ...
        <section className="w-full relative h-[60vh] md:h-[80vh] min-h-[500px] mt-12 mb-24 overflow-hidden group">
          <Image 
        ...
        <section className="max-w-[780px] mx-auto px-6 w-full pb-32">
          <p className="font-sans font-bold text-[20px] md:text-[22px] text-black mb-8 leading-snug">
            The best brands don't tell you what to feel about a place. They make you feel it.
          </p>
          <p className="text-[16px] md:text-[18px] leading-[1.8] text-[#333] mb-12">
        ...
        {/* FOOTER BLOCK */}
        <footer className="w-full border-t border-gray-200 py-12 px-6 md:px-12 lg:px-24 mb-32">
