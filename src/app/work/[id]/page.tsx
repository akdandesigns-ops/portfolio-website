...
const projectDetails: Record<string, ProjectData> = {
  ...
  "solstice-pick": {
    title: "SOLSTICE PICK",
    tagline: "Picking the right identity\nfor a rising brand.",
    category: "Package Design",
    year: "2023",
    client: "Solstice Pick",
    location: "India",
    description:
      "A package design system for Solstice Pick — a brand that needed a distinctive shelf presence. The visual identity combines clean geometry with earthy tones for an organic yet modern feel.",
